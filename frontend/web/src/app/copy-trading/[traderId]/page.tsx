...
import {
  ...
  DataOverview,
  ChartSection,
} from '@/components/copy-trading/trader-details';
import { ChartMetric } from '@/types/trader';
import { useTraderData } from '@/hooks/useTraderData';
import { prepareStatsData, getCurrentChartValue } from '@/utils/traderStats';
  ...
  return (
    <div className="min-h-screen bg-[#090C15] text-white">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeTab !== 'Trading Data' && (
          <div className="bg-[#101010] border border-[#292D32] rounded-xl sm:rounded-2xl p-6 sm:p-12 text-center">
