...
export default function DataOverview({
  ...
  return (
    <div className="bg-[#101010] border border-[#292D32] rounded-xl sm:rounded-2xl p-4 sm:p-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0 mb-4 sm:mb-6">
        <h2 className="text-base sm:text-lg font-regular">Data Overview</h2>
        <div className="flex items-center bg-white/5 border border-white/10 rounded-lg w-full sm:w-auto">
          <button
