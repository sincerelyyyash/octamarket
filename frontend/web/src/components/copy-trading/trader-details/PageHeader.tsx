...
export default function PageHeader({ 
  ...
  return (
    <div className="flex items-center justify-between mb-4 sm:mb-8 gap-4">
      ...
      {showInsightButton && (
        <button className="px-3 sm:px-4 py-1.5 sm:py-2 bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg text-xs sm:text-sm transition-colors flex-shrink-0 cursor-pointer">
