...
export default function TestimonialCard({ name, content }: TestimonialCardProps) {
  return (
    <div className="bg-[#101010] backdrop-blur-sm border border-[#292D32] rounded-xl sm:rounded-2xl p-4 sm:p-6 hover:border-white/20 transition-all duration-300 h-[200px] sm:h-[240px]">
